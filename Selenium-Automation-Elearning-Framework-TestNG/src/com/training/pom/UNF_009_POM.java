...
public class UNF_009_POM {
	private WebDriver driver; 
	
	public UNF_009_POM(WebDriver driver) {
		this.driver = driver; 
	...
	public void addtoCart() {
		...
		String Actmsg = this.alertsuccess.getText().toString().trim();
	...
	public void clickRemove(){
		...
		Assert.assertEquals(emptmsg, expmsg);
		System.out.println("Step 5: PASS - " +emptmsg + " message is displayed");
	}
}
